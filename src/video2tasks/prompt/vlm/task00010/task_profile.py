"""Task profile for VQA task00010."""

from ..question_bank_shared import QAProfile

TASK_CONTEXT = (
    "High-level task: Compactly sort fruits from stand into the brown basket.\nObject inventory (CanonicalRef only):\n- brown basket\n- grape\n- avocado\n- kiwi\n- apple\n- orange\n- pumpkin\n"
)

TASK_PROFILE = QAProfile(
    task_goal="Compactly sort fruits from stand into the brown basket.",
