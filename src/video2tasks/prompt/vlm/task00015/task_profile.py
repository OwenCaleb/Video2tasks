"""Task profile for VQA task00015."""

from ..question_bank_shared import QAProfile

TASK_CONTEXT = (
    "High-level task: Sort and recover fruits with longer recovery sequence into the brown basket.\nObject inventory (CanonicalRef only):\n- brown basket\n- grape\n- avocado\n- kiwi\n- apple\n- orange\n- pumpkin\n"
)

TASK_PROFILE = QAProfile(
    task_goal="Sort and recover fruits with longer recovery sequence into the brown basket.",
