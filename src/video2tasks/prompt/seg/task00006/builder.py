"""Prompt builder for segment task00006."""
...
TASK00006_HIGH_LEVEL = "Sort and recover one object at a time into the brown basket."
TASK00006_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00006 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00006_HIGH_LEVEL}",
        "",
        TASK00006_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
