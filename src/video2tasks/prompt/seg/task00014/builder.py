"""Prompt builder for segment task00014."""
...
TASK00014_HIGH_LEVEL = "Sort fruits into the brown basket."
TASK00014_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00014 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00014_HIGH_LEVEL}",
        "",
        TASK00014_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
