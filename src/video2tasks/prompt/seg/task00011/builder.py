"""Prompt builder for segment task00011."""
...
TASK00011_HIGH_LEVEL = "Sort fruits into the brown basket."
TASK00011_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00011 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00011_HIGH_LEVEL}",
        "",
        TASK00011_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
