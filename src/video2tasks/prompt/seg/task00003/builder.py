"""Prompt builder for segment task00003."""
...
TASK00003_HIGH_LEVEL = "Sort fruits into the black basket and brown basket."
TASK00003_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00003 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00003_HIGH_LEVEL}",
        "",
        TASK00003_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
