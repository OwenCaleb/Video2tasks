"""Prompt builder for segment task00005."""
...
TASK00005_HIGH_LEVEL = "Sort fruits into the brown basket."
TASK00005_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00005 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00005_HIGH_LEVEL}",
        "",
        TASK00005_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
