"""Prompt builder for segment task00015."""
...
TASK00015_HIGH_LEVEL = "Sort and recover fruits with longer recovery sequence into the brown basket."
TASK00015_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00015 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00015_HIGH_LEVEL}",
        "",
        TASK00015_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
