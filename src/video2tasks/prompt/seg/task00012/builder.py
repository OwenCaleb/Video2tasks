"""Prompt builder for segment task00012."""
...
TASK00012_HIGH_LEVEL = "Sort and recover fruits from stand into the brown basket."
TASK00012_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00012 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00012_HIGH_LEVEL}",
        "",
        TASK00012_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
