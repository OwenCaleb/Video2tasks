"""Prompt builder for segment task00008."""
...
TASK00008_HIGH_LEVEL = "Sort fruits from stand into the brown basket."
TASK00008_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00008 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00008_HIGH_LEVEL}",
        "",
        TASK00008_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
