"""Prompt builder for segment task00013."""
...
TASK00013_HIGH_LEVEL = "Sort and recover fruits with longer recovery sequence into the brown basket."
TASK00013_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00013 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00013_HIGH_LEVEL}",
        "",
        TASK00013_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
