"""Prompt builder for segment task00010."""
...
TASK00010_HIGH_LEVEL = "Compactly sort fruits from stand into the brown basket."
TASK00010_OBJECT_INVENTORY = (
    '''Object inventory:
...
def prompt_switch_detection(n_images: int) -> str:
    """Build segment prompt for task00010 with compact rotating examples."""
    lines = [
        (
        ...
        CORE_LOGIC_BLOCK,
        "### Task Context",
        f"High-level task: {TASK00010_HIGH_LEVEL}",
        "",
        TASK00010_OBJECT_INVENTORY,
        CANONICAL_POLICY_BLOCK,
        OUTPUT_FORMAT_BLOCK,
