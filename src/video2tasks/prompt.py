def prompt_switch_detection(n_images: int) -> str:
    return (
        ...
        "Object inventory (some props may repeat; always normalize to CanonicalRef):\n"
        "- Containers:\n"
        ...
        "Half a kiwifruit with a brown fuzzy skin and a green interior : kiwi\n"
        "A purple bunch of grapes : grapes\n"
        "Half a red apple with a white interior : apple\n"
        "A green avocado with a white center and an orange pit : avocado\n"
        ...
        "1. CanonicalRef is the only allowed name to mention that entity anywhere in the output JSON.\n" 
        "2. Descriptors are for disambiguation only.\n\n"
        "### Instruction Template Constraint\n"
        "- Each instruction must strictly match this template (no extra words, no punctuation):\n"
        "Put the <OBJECT> into the <CONTAINER>\n"
        "- <OBJECT> and <CONTAINER> must be CanonicalRefs.\n\n"
